...
try {
  ...
  log "Running fetch_slob_ael.js..."
  node fetch_slob_ael.js 2>&1 | Tee-Object -FilePath $log -Append | Out-String | Write-Output
  ...
  git add cogs_dashboard.html index.html slob_aafl.js slob_hrml.js slob_fal.js slob_ael.js slob_ibos_aafl.js slob_ibos_hrml.js slob_ibos_fal.js slob_ibos_ael.js slob_timelines.js yoy_data.js items_data.js monthly_items.js daily_items.js slob_data.js 2>&1 | Out-String | Write-Output
